...
class _AdminAnalyticsPageState extends State<AdminAnalyticsPage> {
  ...
  /// تحميل الإحصائيات السريعة من API
  Future<void> _loadQuickStats() async {
    ...
    try {
      ...
      // Parse clients from API response
      ...
      // Pending: status in [pending, notified, accepted]
                ...
                background: Container(
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF0B1E3D), Color(0xFF132A4F)],
              ...
              child: Container(
                ...
                child: _statsLoading
                    ...
                    : Column(
                        ...
                        children: [
                          Text('quick_stats'.tr(),
                              style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF37474F))),
                      ...
                      Row(
                        children: [
                          ...
                          Text('ai_analysis_results'.tr(),
                              style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF0B1E3D))),
                        ],
                      ),
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: const TextStyle(fontSize: 14, height: 1.6, color: Color(0xFF455A64)),
                  ),
                ),
              ],
            ),
