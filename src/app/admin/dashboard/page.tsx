...
export default function AdminDashboard() {
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'} className="min-h-screen bg-gray-100 flex flex-col md:flex-row relative">
      ...
      <aside className={`
        fixed md:sticky top-0 right-0 h-screen w-64 bg-gray-900 text-white p-4 flex flex-col shadow-xl z-40 transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full md:translate-x-0'}
      `}>
